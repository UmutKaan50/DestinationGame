...
namespace y01cu {
    ...
    public class TextWriter : MonoBehaviour {
        ...
        public static TextWriterSingle AddWriterWithSpeed_Static(TextMeshProUGUI uiText, string textToWrite,
            float timePerCharacter, bool invisibleCharacters, bool removeWriterBeforeAdd, Action onComplete) {
        ...
        private TextWriterSingle AddWriterWithSpeed(TextMeshProUGUI uiText, string textToWrite, float timePerCharacter,
            bool invisibleCharacters, Action onComplete) {
