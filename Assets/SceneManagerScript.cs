...
public class SceneManagerScript : MonoBehaviour
{
    ...
    private bool animationReverseActivated = false;
    private float fadeRatio = 0;
    private int lvlMenuorMainMenu = 0; //3= loadAnotherScene 2=lvl menu, 1= mainMenu(for animation)
    ...
    public void PlayAnimation()
    {
        ...
        {
            fadePanel.GetComponent<Image>().color = new Color(fadePanel.GetComponent<Image>().color.r, fadePanel.GetComponent<Image>().color.g, fadePanel.GetComponent<Image>().color.b, fadeRatio);
            fadeRatio += 0.1f;
    ...
    {
        string lvlno = Regex.Match(SceneManager.GetActiveScene().name, @"\d+").Value;
