    ...
    public class CharacterMenu : MonoBehaviour {
        ...
        public void OnUpgradeClick() {
            if (GameManager.instance.TryUpgradeWeapon()) {
                SoundController.instance.audioSource.PlayOneShot(SoundController.instance.buySound);
                UpdateMenu();
            }
        }
        ...
        public void UpdateMenu() {
            ...
            if (GameManager.instance.weapon.weaponlevel == GameManager.instance.weaponPrices.Count) {
                ...
                upgradeCostText.text = GameManager.instance.weaponPrices[GameManager.instance.weapon.weaponlevel]
                    .ToString();
            }
        ...
        private Image
            currentChestImage; // The function above acted as we can't assign public Image object inside of it.
        ...
        public void ChestSpriteOpen() {
            SoundController.instance.audioSource.PlayOneShot(SoundController.instance.chestOpen);
            currentChestImage.sprite = openedChestSprite;
            menuButton.GetComponent<Button>().interactable = false;
        }

        public void ChestSpriteClose() {
            SoundController.instance.audioSource.PlayOneShot(SoundController.instance.chestClose);
