...
namespace Destination.Enemies {
    ...
    [Obsolete("This class is deprecated. EnemyNew.cs is the new class to use.")]
    public class Enemy : Mover {
        ...
        protected override void Death() {
            SoundController.instance.audioSource.PlayOneShot(SoundController.instance.skeletonDeath);
            Destroy(gameObject);
